 ...
 * </p>
 */
public class FeedsSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
        NestedScrollingChild {
    // Maps to ProgressBar.Large style
    public static final int LARGE = FeedsMaterialProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = FeedsMaterialProgressDrawable.DEFAULT;

    private static final String LOG_TAG = FeedsSwipeRefreshLayout.class.getSimpleName();
    ...
    private FeedsMaterialProgressDrawable mProgress;
    ...
    public void setSize(int size) {
        if (size != FeedsMaterialProgressDrawable.LARGE && size != FeedsMaterialProgressDrawable.DEFAULT) {
            return;
        }
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        if (size == FeedsMaterialProgressDrawable.LARGE) {
     ...
     * @param context
     */
    public FeedsSwipeRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public FeedsSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
