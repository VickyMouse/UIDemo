package demo.li.opal.uidemo.viewanimator;
...
public class ViewAnimator {
    ...
    protected AnimatorSet createAnimatorSet() {
                ...
                if (!repeatRegistered) {
                    valueAnimator.addListener(new Animator.AnimatorListener() {
                        ...
                        public void onAnimationRepeat(Animator animation) {
                            if (repeatListener != null) repeatListener.onRepeat();
                        }
                    });
        ...
        animatorSet.addListener(new Animator.AnimatorListener() {
            ...
            @Override
            public void onAnimationEnd(Animator animation) {
                if (stopListener != null && !isCancel) stopListener.onStop();
                if (next != null) {
                    next.prev = null;
                    next.start();
                }
    ...
    public ViewAnimator onRepeat(AnimationListener.Repeat repeatListener) {
        this.repeatListener = repeatListener;
        return this;
    }

    public ViewAnimator onCancel(AnimationListener.Cancel cancelListener) {
